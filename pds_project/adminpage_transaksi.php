            ...
            <table id="example" class="table table-striped" style="width:100%; text-align: center;">
              ...
              <tbody>
                ...
                foreach ($cursor as $document) {
                  ...
                  echo "<td>" . $status . "</td>";
                  echo "<td id='btnn".$idtransaksi."'><a type='button' class='btn btn-warning' href='adminpage_edit_transaksi.php?id=".$idtransaksi."'>Update</a></td>";
                  echo "<td id='btnn".$idtransaksi."'><a type='button' class='btn btn-danger' href='delete_transaksi.php?id=".$idtransaksi."'>Delete</a></td>";
                  echo "</tr>";
