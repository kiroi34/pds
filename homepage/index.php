...
<body>
   ...
   <!-- knowledge section end -->
      ...
      <div class="contact_section layout_padding">
         <div class="container">
            <h1 class="health_taital">Why choose 24hr XYZ Clinic</h1>
         <p class="health_text">labore et dolore magna aliqua. Ut enim ad minim veniam</p>
            <div class="news_section_2">
               <div class="row">
                  <div class="col-md-5">
                     <div class="icon_main">
                        <div class="icon_7"><img src="images/icon-2.png"></div>
                        <h4 class="diabetes_text"> Daily care experts </h4>
                     </div>
                     <div class="icon_main">
                        <div class="icon_7"><img src="images/icon-3.png"></div>
                        <h4 class="diabetes_text">Available 24/7 </h4>
                     </div>
                     <div class="icon_main">
                        <div class="icon_7"><img src="images/icon-4.png"></div>
                        <h4 class="diabetes_text">Balanced care </h4>
                     </div>
                  </div>
               </div>
            </div>
   ...
   <div class="news_section layout_padding">
      <div class="container">
         <h1 class="health_taital">Our Speciality</h1>
         <div class="news_section_2 layout_padding">
            <div class="row">
               <div class="col-lg-4 col-sm-6">
                  <div class="box_main">
                     <div class="icon_1"><img src="images/icon-2.png"></div>
                     <h4 class="daily_text">General Practioner Counselling</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-sm-6">
                  <div class="box_main">
                     <div class="icon_1"><img src="images/icon-3.png"></div>
                     <h4 class="daily_text_1">Pediatrics Counselling</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-sm-6">
                  <div class="box_main">
                     <div class="icon_1"><img src="images/icon-4.png"></div>
                     <h4 class="daily_text_1">Dentist Counselling</h4>
                  </div>
               </div>
            </div>
            <br>
            ...
            <div class="row">
               <div class="col-lg-4 col-sm-6">
                  <div class="box_main">
                     <div class="icon_1"><img src="images/icon-2.png"></div>
                     <h4 class="daily_text">ENT Counselling</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-sm-6">
                  <div class="box_main">
                     <div class="icon_1"><img src="images/icon-3.png"></div>
                     <h4 class="daily_text_1">Opthalmology Counselling </h4>
                  </div>
               </div>
            </div>
         </div>
